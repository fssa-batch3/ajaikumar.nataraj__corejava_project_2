...
class TestUpdateOrderFeature {
	...
	void testUpdateOrderSuccess() throws ServiceException {
		...
		Order order = new Order(id, user_id, sellerId, product_id, null, "Apple", 50, 120, phone,
				"10, gandhi street, gobi", "Erode", 638313, currentDate, 0);
